...
export function PauseScreen() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.from('[data-enter]', { y: 24, opacity: 0, filter: 'blur(8px)', duration: 0.8, stagger: 0.12, ease: 'power3.out', delay: 0.1 })
    }, root)
    return () => ctx.revert()
  }, [shown])
  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="rounded-full border border-white/15 p-4 text-white/70 transition hover:border-ember hover:text-ember"
      >
